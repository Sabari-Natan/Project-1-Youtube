...
def Api_connect():
    Api_Id="AIzaSyAvt5zS0c5GwvcnDANdUuKVO56LMX1E7ho"
...
def get_playlist_details(channel_id):
        ...
        while True:
                ...
                for item in response['items']:
                        data=dict(Playslist_Id=item['id'],
                                Title=item['snippet']['title'],
                                Channel_ID=item['snippet']['channelId'],
...
with st.sidebar:
    ...
    st.caption("Python codeing")
    st.caption("Using MongoDB for Data Collection")
    st.caption("API Key getting from Youtube")
    st.caption("Data Bases using MongoDB and SQL")

channel_id=st.text_input("Enter the Channel ID")

if st.button("upload and store channel data"):
    ch_ids=[]
    db=client["Youtube_data"]
    coll1=db["channel_details"]
    for ch_data in coll1.find({},{"_id":0,"channel_information":1}):
...
if st.button("Upload to Postgres Sql"):
...
question=st.selectbox("Select your question",("1. What are the names of all the videos and their corresponding channels",
                                              ...
                                              "4. Total comments in each videos and corresponding video names",
                                              "5. Highest Videos with highest likes",
                                              "6. Total Number likes & dislike of all videos",
                                              "7. Total Number views of each channels",
                                              "8. Name the videos of published in the year of 2022",
                                              "9. Average duration of all videos in each channel",
                                              "10. videos with highest number of comments & Their channel names"))
...
elif question=="4. Total comments in each videos and corresponding video names":
...
elif question=="5. Highest Videos with highest likes":
...
elif question=="6. Total Number likes & dislike of all videos":
...
elif question=="7. Total Number views of each channels":
...
elif question=="8. Name the videos of published in the year of 2022":
    query8='''select title as video_title,videos.published_dates as videorelease,channel_name as channelname from videos
            where extract(year from videos.published_dates)=2022'''
    cursor.execute(query8)
    mydb.commit()
    t8=cursor.fetchall()
    df8=pd.DataFrame(t8,columns=["videotitle","videos.published_dates","channelname"])
    st.write(df8)
...
elif question=="10. videos with highest number of comments & Their channel names":
